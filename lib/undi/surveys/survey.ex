defmodule Undi.Surveys.Survey do
  ...
  def changeset(survey, attrs) do
    survey
    |> cast(attrs, [:country_issued_id, :gender, :age, :sokong_fedaral, :sokong_negeri, :datar_padu])
    |> validate_required([:country_issued_id, :gender, :age, :sokong_fedaral, :sokong_negeri, :datar_padu])
